    ...
    <div id="MainLayout" class="w-full fixed z-50">
      ...
      ">
                ...
                <li 
                    ...
                    class="relative flex items-center px-2.5 hover:text-[#FF4646] cursor-pointer font-medium "
                    :class="isAccountMenu ? 'bg-white border z-40 shadow-[0_15px_100px_40px_rgba(0,0,0,0.3)] p-3' : 'border border-[#FAFAFA]'"
                >   
                    ...
                    <div 
                        id="AccountMenu"
                        v-if="isAccountMenu"
                        class="absolute bg-white w-[220px] text-[#333333] z-40 top-[41px] -left-[100px] border-x border-b"

                    >

                    <div v-if="true">
                        <div class="text-semibold text-[14px] my-4 px-3">
                            Welcome to My Page
                        </div>
        ...
        >
            <div class="flex lg:justify-start justify-between gap-10 max-v-[1150px] w-full px-3 py-5 mx-auto">
                <NuxtLink to="/" class="min-w-[170px]">
                    <img
                        width="170"
                        src="1685524601lazada-logo-png.png"
                    >
                </NuxtLink>
                        ...
                        <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
                            <input
                                class="
                                    ...
                                    focus:outline-none
                                "
                                placeholder="Nhập vật phẩm bạn muốn tìm"
                                type="text"
                                v-model="searchItem"
                                >
                                <Icon
